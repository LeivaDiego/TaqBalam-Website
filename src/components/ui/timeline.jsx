...
export const Timeline = ({ data }) => {
	...
	return (
		<div className="w-full bg-white font-sans md:px-10 dark:bg-neutral-950" ref={containerRef}>
			...
			<div ref={ref} className="relative isolate z-0 mx-auto max-w-7xl pb-20">
				{data.map((item, index) => (
					<div key={index} className="flex justify-start pt-10 md:gap-10 md:pt-40">
						...
						>
							...
							<h3
								className={`hidden text-xl font-bold text-neutral-500 md:block md:pl-20 md:text-5xl
				...
				<div
					...
					className={`pointer-events-none absolute top-0 left-8 z-0 w-[2px] overflow-hidden
						bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%]
						via-neutral-200 to-transparent to-[99%]
